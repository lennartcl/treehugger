...
ConsNode.prototype.getPos = function() {
    ...
    // Loop over all children, considering typeAnno an extra child
    for (var i = 0; i < this.length + 1; i++) {
        var p = this[i] ? this[i].getPos() : (this.typeAnno && this.typeAnno.getPos());
...
ConsNode.prototype.findNode = function(pos) {
    ...
    if(inRange(p, pos)) {
        ...
        // Can't find it in our kids, return self
        return this;
    } else {
        return null;
    }
