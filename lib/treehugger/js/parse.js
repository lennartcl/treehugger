...
exports.transform = function(n) {
    ...
    switch(nodeName) {
        ...
        case "num":
            ...
            break;
        case "type":
            resultNode = tree.cons("Type", [tree.string(n[1]), tree.string(n[2])]);
            break;
        case "string":
        ...
        case "object":
            resultNode = tree.cons("ObjectInit", [tree.list(n[1].map(function(propInit) {
                ...
                var value2 = propInit[2] ? transform(propInit[2]) : undefined;
                var result = tree.cons("PropertyInit", [tree.string(propInit[0]), value2 || value1]);
                result.typeAnno = value2 ? value1 : undefined;
                return result;
            }))]);
            break;
        case "array":
